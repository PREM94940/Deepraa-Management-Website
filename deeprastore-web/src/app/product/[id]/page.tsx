            ...
            <div className="max-w-7xl mx-auto px-6 py-12 md:py-24 grid lg:grid-cols-2 gap-16">
                ...
                <div className="space-y-6 lg:sticky lg:top-24 h-fit">
                    <motion.div 
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        className="aspect-[3/4] bg-gray-100 overflow-hidden cursor-zoom-in relative group"
                    >
                ...
                >
                    ...
                    <button 
                        ...
                        className="w-full flex items-center justify-center gap-3 border border-[#25D366] text-[#25D366] py-4 font-bold uppercase tracking-widest hover:bg-[#25D366] hover:text-white transition-all mb-12"
                    >
