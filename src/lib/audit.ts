...
export type AuditAction = 'INSERT' | 'UPDATE' | 'DELETE' | 'APPROVAL' | 'LOGISTICS_UPDATE' | 'UNAUTHORIZED_ACCESS_ATTEMPT' | 'MANUAL_REFUND_OVERRIDE' | 'CUSTOMER_RETURN_REQUEST' | 'REFUND_PROCESSED' | 'ORDER_STATUS_CHANGED' | 'INVENTORY_MANUAL_OVERRIDE' | 'ADMIN_ACCESS' | 'LOG_SUSPICIOUS_LOGIN';
