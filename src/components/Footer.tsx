    ...
    return (
        <footer className="bg-[#0A0A0A] text-white pt-24 pb-12 px-6 border-t border-[#1C1C1C]">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
                ...
                <div>
                    <h2 className="text-lg font-bold mb-8 uppercase tracking-widest">Shop</h2>
                ...
                <div>
                    <h2 className="text-lg font-bold mb-8 uppercase tracking-widest">Company</h2>
                    <ul className="space-y-4 opacity-60">
                ...
                <div>
                    <h2 className="text-lg font-bold mb-8 uppercase tracking-widest">Newsletter</h2>
                    ...
                    <div className="relative">
                        ...
                        <button className="absolute right-2 top-2 bg-accent text-white p-2 rounded-lg" aria-label="Subscribe to newsletter">
