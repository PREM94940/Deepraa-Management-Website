    ...
    return (
        <div className="w-full relative z-50">
            ...
            <div className="flex items-center gap-6">
                ...
                <Link href="/wishlist" aria-label="Wishlist" className="hover:text-accent transition-colors">
                ...
                <button onClick={() => setIsOpen(true)} aria-label="Open Cart" className="relative hover:text-accent transition-colors">
